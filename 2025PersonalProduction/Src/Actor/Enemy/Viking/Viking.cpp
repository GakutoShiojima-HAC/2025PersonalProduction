...
void Viking::dash_effect_start() {
    ...
    dash_effect_handle_ = play_effect((GSuint)EffectID::DashSonic, GSvector3{ 0.0f, 1.5f, 1.0f });
}
...
void Viking::update_dash_effect(float delta_time) {
    if (dash_effect_enabled_) {
        ...
        GSmatrix4 world = local_to_world(GSvector3{ 0.0f, 1.5f, 1.0f }, GSvector3::zero(), GSvector3::one());
